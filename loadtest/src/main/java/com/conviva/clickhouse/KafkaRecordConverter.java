...
public class KafkaRecordConverter {
    ...
    public static void main(String[] args) {
        ...
        String topic = "experience_insights.session_summaries.PT1M.8";
        String groupid = "dytest";

        int sleepintervel = 5;
        String maxpollinter = "300000";
        ...
        props.put("bootstrap.servers", "rccp101-1a.iad5.prod.conviva.com:32721");

        // props.put("bootstrap.servers", "kafka060.bx:9092");
        ...
        props1.put("bootstrap.servers",
                "rccp207-10c.iad4.prod.conviva.com:30501");
