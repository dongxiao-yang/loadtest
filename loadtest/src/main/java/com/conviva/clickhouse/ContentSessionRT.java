...
//    public String[] life_videoStartFailureErrorsTech = new String[0];
    ...
    public long streamingMetadata_realtimeQueryTimestampMs;
    public long streamingMetadata_watermarkMs;
    public int streamingMetadata_partitionId;
    ...
    public int switch_adPlayingTimeMs;
    public int switch_compensationTimeMs;
    public int switch_hasPlayingTime;
    ...
    public void setStreamingMetadata_realtimeQueryTimestampMs(long streamingMetadata_realtimeQueryTimestampMs) {
        this.streamingMetadata_realtimeQueryTimestampMs = streamingMetadata_realtimeQueryTimestampMs;
    }

    public void setStreamingMetadata_watermarkMs(long streamingMetadata_watermarkMs) {
        this.streamingMetadata_watermarkMs = streamingMetadata_watermarkMs;
    }

    public void setStreamingMetadata_partitionId(int streamingMetadata_partitionId) {
        this.streamingMetadata_partitionId = streamingMetadata_partitionId;
    }
    ...
    public void setSwitch_adPlayingTimeMs(int switch_adPlayingTimeMs) {
        this.switch_adPlayingTimeMs = switch_adPlayingTimeMs;
    }

    public void setSwitch_compensationTimeMs(int switch_compensationTimeMs) {
        this.switch_compensationTimeMs = switch_compensationTimeMs;
    }

    public void setSwitch_hasPlayingTime(int switch_hasPlayingTime) {
        this.switch_hasPlayingTime = switch_hasPlayingTime;
    }
    ...
    public String toSparkTSV() {
        ...
        sb.append(version).append(DEFAULT_SEPARATOR)
                ...
                .append(streamingMetadata_realtimeQueryTimestampMs).append(DEFAULT_SEPARATOR)
                .append(streamingMetadata_watermarkMs).append(DEFAULT_SEPARATOR)
                .append(streamingMetadata_partitionId).append(DEFAULT_SEPARATOR)
                ...
                .append(switch_adPlayingTimeMs).append(DEFAULT_SEPARATOR)
                .append(switch_compensationTimeMs).append(DEFAULT_SEPARATOR)
                .append(switch_hasPlayingTime).append(DEFAULT_SEPARATOR)
