...
//        String jsonfilename = "/Users/dyang/Documents/workspace/loadtest/loadtest/contentsession/part-00049-261e47f4-9870-46ff-a653-9c3eb284a606.c000.txt";
        ...
        String outputfile = "contentSession.tsv";
...
//        ObjectMapper objectMapper = new ObjectMapper();
        ...
        System.out.println("end:" + DateTime.now() + " with totally records :" + recordcount);


    }


    public static void parsefile(File input, PrintWriter writer) {
        try {
